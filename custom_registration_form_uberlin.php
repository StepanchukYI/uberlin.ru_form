...
<div style="text-align: center;"><h5>Реквизиты Принципала:</h5></div>
    <table border="0" align="center">
        ...
        <tr>
            <td>2. Дата рождения:</td>
            <td>' . $bdate . '</td>
        </tr>
        <tr>
            <td>3. Место рождения:</td>
            <td>' . $bplace . '</td>
        </tr>
		<tr>
            <td>4. Серия и номер паспорта:</td>
            <td>' . $passport . '</td>
        </tr>
		<tr>
            <td>5. Кем выдан:</td>
		...
		<tr>
            <td>9. Наименование банка:</td>
            <td>' . $bankName . '</td>
        </tr>
		<tr>
            <td>10. Счет получателя:</td>
            <td>' . $poluchCode . '</td>
        </tr>
		<tr>
			<td>11. Назначение платежа:</td>
			<td> Для зачисления на карту № ' . $poluchCode . ' ' . $fiouser . ' по договору оказания посреднических услуг номер 5-63B от 25.05.2017. НДС не облагается.</td>
		</tr>
		<tr>
        ...
        <tr>
            <td>13. Адрес электронной почты:</td>
            <td>' . $email . '</td>
        </tr>
        <tr>
            <td>14. Номер отдела выдачи паспорта:</td>
            <td>' . $rovInfo . '</td>
        </tr>              
        <tr>
            <td>15. Корр. счет банка:</td>
            <td>' . $korrBank . '</td>
        </tr>
        <tr>
            <td>16. Номер карты:</td>
            <td>' . $bankCard . '</td>
        </tr>
       </table>
	<table>
